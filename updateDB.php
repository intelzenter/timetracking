<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('practice_time_table', "create table if not exists `practice_time_table` (   `id` INT unsigned not null auto_increment , primary key (`id`), `day` VARCHAR(40) not null , `time_start` TIME not null , `time_end` TIME not null , `unit_code` VARCHAR(40) not null , `venue` VARCHAR(40) not null , `school` INT unsigned not null , `department` INT unsigned not null , `year_of_study` VARCHAR(40) not null ) CHARSET utf8", $silent);
		setupIndexes('practice_time_table', array('school','department'));
		setupTable('game_time_table', "create table if not exists `game_time_table` (   `id` INT unsigned not null auto_increment , primary key (`id`), `date` DATE not null , `time_start` TIME not null , `time_end` TIME not null , `unit_code` VARCHAR(40) not null , `venue` VARCHAR(40) not null , `school` INT unsigned not null , `department` INT unsigned not null , `year_of_study` VARCHAR(40) not null ) CHARSET utf8", $silent);
		setupIndexes('game_time_table', array('school','department'));
