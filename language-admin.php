<?php
	...
	$Translation['sporttracker forum'] = "sporttracker Community Forum";
	...
	$Translation['data ownership'] = "Sometimes, you might have tables with data that were entered before implementing this sporttracker membership management system, or entered using other applications unaware of sporttracker ownership system. This data currently has no owners. This page allows you to assign owner groups and owner members to this data.";
	...
	$Translation["sporttracker tweets"]  = "Tweets By sporttracker Software";
	$Translation["follow sporttracker"] = "Follow @sporttracker";
	$Translation["loading sporttracker feed"] = "Loading @sporttracker feed ...";
	...
	$Translation['compare tables page'] = "This page compares the tables and fields structure/schema as designed in sporttracker to the actual database structure and allows you to fix any deviations.";
	$Translation['field'] = "Field";
	$Translation['sporttracker definition'] = "sporttracker definition";
	...
	$Translation['fix field'] = "Fix the field by running an ALTER COLUMN query so that its definition becomes the same as that in sporttracker.";
	$Translation['fix it'] = "Fix it";
	$Translation['field update warning'] = "DANGER!! In some cases, this might lead to data loss, truncation, or corruption. It might be a better idea sometimes to update the field in sporttracker to match that in the database. Would you still like to continue?";
