<?php
	...
	// PLEASE NOTE:
	// ============
	// When a new version of sporttracker is released, new strings
	...
	/* Added in sporttracker 4.90 */
	$Translation['Records to display'] = 'Records to display';
	
	/* Added in sporttracker 5.10 */
	...
	$Translation['db_name help'] = 'The name of the database you want to run your sporttracker application in.';
