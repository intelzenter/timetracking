	...
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-primary o-hidden h-100">
			<div class="card-body">
				...
				<div class="mr-5">Practice Time Table</div>
			</div>
	...
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-warning o-hidden h-100">
			<div class="card-body">
				...
				<div class="mr-5">Games Time Table</div>
			</div>
...
<div class="card mb-12">
	<div class="card-header">
		<i class="fa fa-table"></i> <strong>Practices Today: <?php echo date('D-d-M-Y'); ?></strong>
	</div>
	<div class="card-body">
...
<div class="card mb-3">
	<div class="card-header">
		...
		<div class="mb-0 mt-4">
			<i class="fa fa-newspaper-o"></i> Games Schedule</div>
			<hr class="mt-2">
		</div>
		<div class="card mb-12">
			<div class="card-header">
				<i class="fa fa-table"></i> <strong>Games Today: <?php echo date('D-d-M-Y'); ?></strong>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
