...
practice_time_table_addTip=["",spacer+"This option allows all members of the group to add records to the 'Practice Time Table' table. A member who adds a record to the table becomes the 'owner' of that record."];

practice_time_table_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Practice Time Table' table."];
practice_time_table_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Practice Time Table' table."];
practice_time_table_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Practice Time Table' table."];
practice_time_table_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Practice Time Table' table."];

practice_time_table_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Practice Time Table' table."];
practice_time_table_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Practice Time Table' table."];
practice_time_table_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Practice Time Table' table."];
practice_time_table_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Practice Time Table' table, regardless of their owner."];

practice_time_table_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Practice Time Table' table."];
practice_time_table_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Practice Time Table' table."];
practice_time_table_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Practice Time Table' table."];
practice_time_table_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Practice Time Table' table."];

// game_time_table table
game_time_table_addTip=["",spacer+"This option allows all members of the group to add records to the 'Games Time Table' table. A member who adds a record to the table becomes the 'owner' of that record."];

game_time_table_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Games Time Table' table."];
game_time_table_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Games Time Table' table."];
game_time_table_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Games Time Table' table."];
game_time_table_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Games Time Table' table."];

game_time_table_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Games Time Table' table."];
game_time_table_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Games Time Table' table."];
game_time_table_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Games Time Table' table."];
game_time_table_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Games Time Table' table, regardless of their owner."];

game_time_table_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Games Time Table' table."];
game_time_table_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Games Time Table' table."];
game_time_table_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Games Time Table' table."];
game_time_table_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Games Time Table' table."];
