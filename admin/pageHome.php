...
<?php if(!$adminConfig['hide_twitter_feed']){ ?>
		...
		<div class="col-md-4" id="twitter-feed">
			<h3>
				<?php echo $Translation["sporttracker tweets"]; ?>
				<span class="pull-right">
					<a class="twitter-follow-button" href="https://twitter.com/sporttracker" data-show-count="false" data-lang="en"><?php echo $Translation["follow sporttracker"]; ?></a>
